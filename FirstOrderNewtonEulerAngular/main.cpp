/*
Title: First Order Newton - Euler Integration (Angular)
File Name: main.cpp
Copyright © 2015
...
first order Newton - Euler integration to solve for it's angular velocity & orientation each
frame. You can reset the object's angular velocity to 0 by pressing spacebar.
...
//Compile shader source into program
...
void update(float dt)
{
	...
	if (glfwGetKey(window, GLFW_KEY_SPACE) == GLFW_PRESS) triangleBody->angularVelocity = glm::vec3(0.0f);
...
void main()
{
	...
	// Creates a window
	window = glfwCreateWindow(800, 800, "First Order Newton - Euler Integration (Angular)", nullptr, nullptr);
	...
	triangleBody = new struct RigidBody(
		...
		glm::vec3(0.0f),			//Not accelerating
	...
	//Print controls
	std::cout << "Controls:\nPress spacebar to reset the objects angular velocity to 0.\n";
